              ...
              <div>
                ...
                <div className="mb-4">
                  <h3 className="text-xl font-serif font-black tracking-tight text-natural-dark mb-1">
                    {authMode === 'login' ? 'Welcome Back, Partner' : 'Secure Allocation Gate'}
                  </h3>
                  <p className="text-xs text-natural-secondary font-semibold">
                    {authMode === 'login' ? 'Sign in to monitor yields and CFD margins.' : 'Create an account to begin copy strategies.'}
                  </p>
                </div>
